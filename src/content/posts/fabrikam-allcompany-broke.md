...
![Illustration of a multi-tenant organization: Contoso and Fabrikam Entra ID tenants linked by Cross-Tenant Sync, with synced external users flowing into Fabrikam's All Company group](/images/fabrikam-allcompany-broke/f7ebee70-a5f2-47dd-ab7b-9d70a78ce0d1.png)
...
![Illustration showing automatic org-wide provisioning pushing Contoso users into Fabrikam's All Company group until it exceeds the 10,000-member limit and converts to a public group](/images/fabrikam-allcompany-broke/f2b28f5a-f2f9-47b6-b62c-1b33693eaf83.png)
...
![Illustration of a dynamic membership rule applied to the All Company group to exclude external Contoso users by userPrincipalName](/images/fabrikam-allcompany-broke/74ebabb8-2786-4c4d-ab6b-b3d6048e382e.png)
...
![Illustration comparing the All Company group after cleanup versus after a soft-deleted Contoso user is restored, showing the restored member reappearing with no audit-log entry](/images/fabrikam-allcompany-broke/952e3893-d9de-460e-b38e-439d244405b7.png)
...
![Illustration of the correction: keep dynamic membership and permanently delete any soft-deleted Contoso users so restored accounts stop rejoining the group](/images/fabrikam-allcompany-broke/c4166405-da6f-4aa3-b3d7-7fcf9f4d6ded.png)
