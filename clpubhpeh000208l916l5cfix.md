...
seoTitle: "Mastering Edge Profiles for Microsoft 365 Management"
seoDescription: "Explore how to use Edge profiles for efficient Microsoft 365 tenant management in this easy-to-follow guide."
datePublished: 2023-12-06T22:04:51.546Z
cuid: clpubhpeh000208l916l5cfix
slug: edge-profile-pro-tips
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1701899705908/740eeb0e-1fe3-43ee-9ff6-cb7b682e2e62.png
ogImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1701899783729/d941e019-e30b-4601-a568-eb0809beb762.png
tags: microsoft-edge, microsoft-edge-profiles, microsoft-365-tenant-administration, m365-admin
...
* **Initial Login:**
    ...
    * ![A screen shot of a sign in to Edge](https://cdn.hashnode.com/res/hashnode/image/upload/v1701896597602/1fe2b535-63ee-4012-a25d-671f5c117949.png align="left")
...
* **Your Appearance Settings:**
    ...
    * Here's where you can jazz things up a bit. Head over to the Overall appearance settings and make it your own. I’m a big fan of Vertical tabs (trust me, once you go Vertical, you never go back) and ditching the title bar. Here’s how:
        ...
        * ![Instructions previously mentioned on how to enable Brian's custom Edge experience.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701897455399/feeb1858-b402-49ff-8e5c-4997a7c324fe.png align="left")
...
* **Signing Into Microsoft 365:**
    ...
    * ![A screenshot of the Microsoft 365 admin portal demonstrating successful login of the user profile after signing into Edge.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898365698/f3369a6c-ca5a-48df-8dd6-7ab9f21ff7f4.png align="left")
...
* **Create a new Profile:**
    ...
    * ![A screenshot example highlighting the options listed previously. ](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898484312/0f742bc8-e6eb-4ed3-a68d-28c3c3daa0cb.png align="left")
        
* **Login to Edge with the new profile:**
    
    * Sign into Edge again, but this time with your other profile details.
        
    * ![A screenshot demonstrating the addition of a profile to the Edge browser.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898552506/b7a00cea-0c43-4755-af6f-f559f3223b0b.png align="left")
...
* **Managing Sign-In Preferences**
    ...
    * ![A screenshot of the prompt: 6) You’ll see a prompt asking if you want “Windows to remember your account and automatically sign you in to your apps and websites on this device.”  a. Select “No, sign in to this app only.”](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898657516/3c4897c8-032e-4598-aff1-4307fe4f3fef.png align="left")
...
* **Setting Up Your Profile Look:**
    ...
    * ![A screenshot of the new profile with a yellow theme in the Edge browser.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898711301/8bcdbd30-8a08-44be-a5a9-da249046f93a.png align="left")
...
* **Adjust Profile-Specific Settings:**
    ...
    * ![Demonstrating where to click in the Edge profile to select the gear icon to edit profile settings](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898788190/4700b1af-95c6-4994-b2c5-924ea0c6f83d.png align="left")
        
    * Pro tip: Rename your profile to something more intuitive than “*Work 2*” – maybe use the user’s email address?
        
    * ![Demonstrating the renaming of an Edge profile.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898829026/ad38c07d-8446-4a6e-804c-5372c34219cb.png align="left")
...
* **Fine-Tune Sign-In Settings:**
    ...
    * ![A screenshot of the profile preferences page that demonstrates the two preferences to be set.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701898957731/70e03b63-dea1-44bc-a54d-ec9b5d2d3473.png align="left")
...
* **Final Steps for Each Profile:**
    ...
    * ![A screenshot of the Microsoft 365 sign-in screen](https://cdn.hashnode.com/res/hashnode/image/upload/v1701899095728/f110165f-7f46-45b1-b2a7-1102bfd4f04e.png align="left")
    ...
    * ![A screenshot of two edge browser windows in different profiles side by side logged into two different Microsoft 365 tenants.](https://cdn.hashnode.com/res/hashnode/image/upload/v1701899210646/b2402e40-b82f-48b4-832c-45031901bdb5.png align="center")
